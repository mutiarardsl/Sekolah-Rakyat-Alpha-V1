...
const ProfileSection = ({ progressData, onChangePwd }) => {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', height: '100%', width: '100%', overflow: 'hidden', background: C.bg }}>
            ...
            {/* ── Scrollable content ── */}
            <div style={{ flex: 1, overflowY: 'auto', padding: '16px 22px 20px', background: C.bg }}>

                {/* ── Leaderboard ── */}
                <div style={{ display: 'flex', gap: 20, alignItems: 'flex-start', flexDirection: isMobile ? 'column' : 'row' }}>

                    {/* ── Kolom kiri: Leaderboard ── */}
                    <div style={{ flex: 1.4, display: 'flex', flexDirection: 'column', gap: 20, paddingRight: isMobile ? 0 : 20, width: isMobile ? '100%' : 'auto' }}>
                    ...
                    {/* ── Profile Card ── */}
                    <div style={{ flex: 1, flexDirection: 'column', width: isMobile ? '100%' : 'auto', minWidth: 0 }}>
                        <div style={{
