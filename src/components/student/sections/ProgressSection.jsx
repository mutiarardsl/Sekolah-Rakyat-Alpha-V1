  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', width: '100%', overflow: 'hidden', background: C.bg }}>
      ...
      <div style={{ flex: 1, minHeight: 0, display: 'flex', overflow: 'auto', padding: `0 var(--content-px, 24px) 20px`, gap: 14, flexDirection: (isMobile || isTablet) ? 'column' : 'row' }}>
        ...
        <div style={{ width: (isMobile || isTablet) ? '100%' : 340, flexShrink: 0, background: C.white, borderRadius: 14, border: '1.5px solid #E8EDF2', overflowY: 'auto', maxHeight: (isMobile || isTablet) ? 260 : '100%', boxShadow: '0 2px 10px rgba(26,35,50,.06)' }}>
        ...
        <div style={{ flex: 1, minWidth: 0, background: C.white, borderRadius: 14, border: '1.5px solid #E8EDF2', overflow: 'hidden', display: 'flex', flexDirection: 'column', boxShadow: '0 2px 10px rgba(26,35,50,.06)' }}>
          {selectedMapel ? (
            <ElemenPanel
              mapel={selectedMapel}
